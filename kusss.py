...
class Student:
    def __init__(self, discord_id: str, calendar_link: str, courses: list[CourseKey], matr_nr: str = None):
...
def student(discord_id: str, link: str, matr_nr: str = None) -> Student:
